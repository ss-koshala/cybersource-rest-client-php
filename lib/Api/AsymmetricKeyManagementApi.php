...
class AsymmetricKeyManagementApi
{
    ...
    public function createP12KeysWithHttpInfo($createP12KeysRequest)
    {
        ...
        $part = explode('\\', '\CyberSource\Model\CreateP12KeysRequest');
        $endPart = end($part);
    ...
    public function deleteBulkP12KeysWithHttpInfo($deleteBulkP12KeysRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\DeleteBulkP12KeysRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function updateAsymKeyWithHttpInfo($keyId, $updateAsymKeysRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\UpdateAsymKeysRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());

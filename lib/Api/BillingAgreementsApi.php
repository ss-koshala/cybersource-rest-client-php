...
class BillingAgreementsApi
{
    ...
    public function billingAgreementsDeRegistrationWithHttpInfo($modifyBillingAgreement, $id)
    {
        ...
        $part = explode('\\', '\CyberSource\Model\ModifyBillingAgreement');
        $endPart = end($part);
    ...
    public function billingAgreementsIntimationWithHttpInfo($intimateBillingAgreement, $id)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\IntimateBillingAgreement');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function billingAgreementsRegistrationWithHttpInfo($createBillingAgreement)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\CreateBillingAgreement');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());

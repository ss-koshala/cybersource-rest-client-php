...
class DecisionManagerApi
{
    ...
    public function actionDecisionManagerCaseWithHttpInfo($id, $caseManagementActionsRequest)
    {
        ...
        $part = explode('\\', '\CyberSource\Model\CaseManagementActionsRequest');
        $endPart = end($part);
    ...
    public function addNegativeWithHttpInfo($type, $addNegativeListRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\AddNegativeListRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function commentDecisionManagerCaseWithHttpInfo($id, $caseManagementCommentsRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\CaseManagementCommentsRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function createBundledDecisionManagerCaseWithHttpInfo($createBundledDecisionManagerCaseRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\CreateBundledDecisionManagerCaseRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function fraudUpdateWithHttpInfo($id, $fraudMarkingActionRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\FraudMarkingActionRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());

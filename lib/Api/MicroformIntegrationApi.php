...
class MicroformIntegrationApi
{
    ...
    public function generateCaptureContextWithHttpInfo($generateCaptureContextRequest)
    {
        ...
        $exploded = explode('\\', '\CyberSource\Model\GenerateCaptureContextRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($exploded), $this->apiClient->merchantConfig->getRunEnvironment());

...
class PayerAuthenticationApi
{
    ...
    public function checkPayerAuthEnrollmentWithHttpInfo($checkPayerAuthEnrollmentRequest)
    {
        ...
        $part = explode('\\', '\CyberSource\Model\CheckPayerAuthEnrollmentRequest');
        $endPart = end($part);
    ...
    public function payerAuthSetupWithHttpInfo($payerAuthSetupRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\PayerAuthSetupRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function validateAuthenticationResultsWithHttpInfo($validateRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\ValidateRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());

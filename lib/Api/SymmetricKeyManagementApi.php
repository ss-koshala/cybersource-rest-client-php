...
class SymmetricKeyManagementApi
{
    ...
    public function createV2SharedSecretKeysWithHttpInfo($createSharedSecretKeysRequest)
    {
        ...
        $part = explode('\\', '\CyberSource\Model\CreateSharedSecretKeysRequest');
        $endPart = end($part);
    ...
    public function createV2SharedSecretKeysVerifiWithHttpInfo($vIcDomain, $createSharedSecretKeysVerifiRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\CreateSharedSecretKeysVerifiRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function deleteBulkSymmetricKeysWithHttpInfo($deleteBulkSymmetricKeysRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $part = explode('\\', '\CyberSource\Model\DeleteBulkSymmetricKeysRequest');
        $endPart = end($part);
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, $endPart, $this->apiClient->merchantConfig->getRunEnvironment());
